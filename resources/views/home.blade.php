...
@section('carousel')
    ...
    <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-item active">
            <div class="view"
            style="background-image: url('{{ asset('fe-wtl/img/banner/wtl-5.jpg') }}'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
                ...
                <p class="mb-4 d-none d-md-block">
                    <strong>Kelompok remaja ini berlokasikan di tempat wisata Waduk Sempor Kabupaten Kebumen, Jawa
                    Tengah.</strong>
                </p>
                ...
                <div class="row">
                    ...
                    <div class="mb-5 flex-center">
                        ...
                        <!-- Facebook -->
                        <a class="fb-ic">
                        <i class="fab fa-facebook-f fa-lg white-text mr-md-5  mr-2"> </i>
                        </a>
                        <!-- Twitter -->
                        <a class="tw-ic">
        ...
        <div class="carousel-item">
            <div class="view"
            style="background-image: url('{{ asset('fe-wtl/img/banner/wtl-4.jpg') }}'); background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="carousel-item">
            <div class="view"
            style="background-image: url('{{ asset('fe-wtl/img/banner/wtl-3.jpg') }}'); background-repeat: no-repeat; background-size: cover;">
...
@section('content')
    ...
    <div class="container">
        ...
        <!--Section heading-->
        <h1 class="font-weight-bold text-center h1 my-5">Produk WTL</h1>
        <!--Section description-->
    ...
    <div class="container">
        ...
        <!--Section heading-->
        <h2 class="font-weight-bold text-center h1 my-5">Berita WTL</h2>
        <!--Section description-->
